...
run_client_without_server_test "Create User without server" "qemu-riscv64 ./client $name1 create " "expected_output/expected_output.txt" "expected_output/expected_client_output.txt" 5 $name1
run_server_without_client_test "Create User without client" "expected_output/expected_client_output.txt" 5 $name1
